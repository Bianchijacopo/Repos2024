...
namespace ThreadGym
{
    class Program
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine("{0} Thread can enter the semaphore.", semaphore.CurrentCount);
            ...
            for (int i = 0; i <= 4; i++)
            {
                threads[i] = new Thread(() =>
                {
                    ...
                    Console.WriteLine("Thread {0} releases the semaphore; previous count: {1}.", Thread.CurrentThread.ManagedThreadId, semaphore.Release());
                });
            }
            ...
            semaphore.Release(3);
            Console.WriteLine("{0} Threads can enter the semaphore.", semaphore.CurrentCount);
